...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9db73a7e531b70563a8c8dccfc0a57ca) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build Unix library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build Xen library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "true to build Xen kernelspace console";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build kFreeBSD library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "mirage_console";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Conproto"; "S"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-console";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_console_backend";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("xenstore", None);
                           InternalLibrary "mirage_console";
                           ...
                           FindlibPackage
                             ("shared-memory-ring.console", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage_console";
                      lib_findlib_name = Some "backend";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_console_xen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "miragexen", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "xen";
                      bs_compiled_object = Best;
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-console-xen";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_console_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-console-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_console_kfreebsd";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-console-kfreebsd";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "mirage_console_cli";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "xen", OASISExpr.EFlag "unix"),
                             true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mirage_console";
                           InternalLibrary "mirage_console_unix";
                           ...
                           FindlibPackage ("xen-gnt", None);
                           InternalLibrary "mirage_console_backend";
                           FindlibPackage ("xenstore", None);
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "portable.ml"});
               Test
                 ({
                     cs_name = "portable_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\149a\141\155\136\231j\161\208a\150D|Y\239\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
